...
kolera_numbers %>%
  ...
  labs(
    title = "New deaths under the cholera epidemic in Copenhagen 1853",
    x = "Date",
    y = "Number")
...
kolera_numbers %>%
  ggplot(aes(Date,y=total_deaths, color=new_deaths))+
  geom_point()+
  geom_smooth(method = "loess", color="hotpink")+
  geom_point()+
  theme_bw()+
  scale_color_gradient(low="black", high="hotpink")+
  labs(
    title = "Total deaths under the cholera epidemic in Copenhagen 1853",
    x = "Date",
    y = "Number"
  )
...
kolera_numbers %>%
  ...
  labs(
    title = "New cases under the cholera epidemic in Copenhagen 1853",
    x = "Date",
    y = "Number"
  )
...
kolera_numbers %>%
  ...
  scale_color_gradient(low="darkblue", high="lightblue")+
  labs(
    title = "Total cases under the cholera epidemic in Copenhagen 1853",
    x = "Date",
    y = "Number"
  )
